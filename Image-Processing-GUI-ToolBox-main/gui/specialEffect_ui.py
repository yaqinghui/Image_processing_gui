...
# Form implementation generated from reading ui file 'specialEffect_ui.ui'
#
...
"}")
        ...
        self.apply_button.setGeometry(QtCore.QRect(412, 290, 101, 28))
        ...
        self.apply_button_1.setGeometry(QtCore.QRect(412, 290, 101, 28))
    ...
    def retranslateUi(self, noiseAddDialog):
        ...
        self.label_15.setText(_translate("noiseAddDialog", "图像特效"))
        self.slider2_counter.setText(_translate("noiseAddDialog", "0"))
        self.apply_button.setText(_translate("noiseAddDialog", "应用效果"))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab), _translate("noiseAddDialog", "生成草图"))
        self.slider3_counter.setText(_translate("noiseAddDialog", "0"))
        self.apply_button_1.setText(_translate("noiseAddDialog", "应用效果"))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab_2), _translate("noiseAddDialog", "凹透镜"))
        self.slider5_counter.setText(_translate("noiseAddDialog", "0"))
        self.label_11.setText(_translate("noiseAddDialog", "A"))
        self.apply_button_2.setText(_translate("noiseAddDialog", "应用效果"))
        ...
        self.tabs.setTabText(self.tabs.indexOf(self.tab_3), _translate("noiseAddDialog", "凸透镜"))
